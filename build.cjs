...
<button id="back-to-top-btn" class="fixed bottom-6 right-6 bg-slate-800/80 backdrop-blur border border-slate-700 text-white w-12 h-12 rounded-full flex items-center justify-center opacity-0 invisible transition-all hover:bg-slate-700 hover:border-slate-600 z-50 shadow-lg" aria-label="Voltar para o topo">
...
// Ensure absolutely no instance of "c-o-d-e" strings in output by removing them (if any).
