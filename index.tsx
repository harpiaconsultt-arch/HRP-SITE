    ...
    container.innerHTML = recentPosts.map(post => `
        <div class="bg-slate-900 rounded-lg overflow-hidden border border-slate-800 flex flex-col group">
            <div class="p-6 flex-grow">
                ...
                <h3 class="text-lg font-bold text-white mb-2 group-hover:text-primary transition-colors font-montserrat">${post.title}</h3>
